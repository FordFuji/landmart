...
<style>
    .order_status li:nth-child(5) {
        border: 2px solid var(--lightgray);
    }

    .order_status li:nth-child(5) a {
        color: var(--blue);
    }
</style>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" style="vertical-align:middle;">
                        ...
                        <span class="lightgray">ยกเลิกคำสั่งซื้อ </span>
                    </td>
                    <td class="text-center" style="vertical-align:middle;">
                        <div class="redtxt">
                            <b> ยกเลิกโดยลูกค้า </b> <br> เปลี่ยนใจ
                        </div>
                    </td>

                    <td class="text-center" colspan="2" style="vertical-align:middle;">

                        <b class="blacktxt">หมายเหตุ</b>
                        <br>
                        <span class="lightgray">
                            พอดีลูกค้ากดสั่งซื้อผิดค่ะ
                        </span>
        ...
        <table class="table table_box_c table-bordered mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" style="vertical-align:middle;">
                        <div class="redtxt">
                            <b> ยกเลิกโดย <br> LANDMART </b> <br> รับคำร้อง
                        </div>
                    </td>
                    ...
                    <td class="text-center" colspan="2" style="vertical-align:middle;">
                        ...
                        <br>
                        <span class="lightgray">
                            ลูกค้าขอยกเลิก <br> แต่กดยกเลิกสินค้าไม่เป็น
                        </span>
