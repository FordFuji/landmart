...
$filename1 = substr(strrchr($product_image['image'], '/'), 1); 
$ext1 = substr(strrchr($filename1, '.'), 1);
?>

<tr id="image-row<?php echo $image_row; ?>">
    <td class="text-left">
        <a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail" style="position:relative;">
...
//echo $filename1;
?>
<img src="../image/catalog/pdf.jpg" /><div style="position:absolute; top:60px; width:100%; text-align:center;word-wrap: break-word; padding:0px 7px;"><?php echo $filename1; ?></div>
<?php 
} 
elseif($ext1 == 'mp4') 
{ 
//echo $filename1; 
?>
<video width="100" height="100" controls="controls"><source src="../image/<?php echo $product_image['image']; ?>" type="video/mp4"></video>
<?php
} 
else 
{ 
