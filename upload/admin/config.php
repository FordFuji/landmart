...
if($_SERVER['SERVER_NAME'] == 'localhost') {
    ...
    // DIR
    define('DIR_APPLICATION', 'G:/xampp_7427/htdocs/landmart/upload/admin/');
    ...
    define('DIR_CATALOG', 'G:/xampp_7427/htdocs/landmart/upload/catalog/');
    ...
    // HTTP
    define('HTTP_SERVER', 'http://ford.orangeworkshop.info/landmart/admin/');
    define('HTTP_CATALOG', 'http://ford.orangeworkshop.info/landmart/');

    // HTTPS
    define('HTTPS_SERVER', 'https://ford.orangeworkshop.info/landmart/admin/');
    define('HTTPS_CATALOG', 'https://ford.orangeworkshop.info/landmart/');

    // DIR
    define('DIR_APPLICATION', '/home/zford/domains/ford.orangeworkshop.info/public_html/landmart/admin/');
    ...
    define('DIR_STORAGE', DIR_SYSTEM . 'storage/');
    define('DIR_CATALOG', '/home/zford/domains/ford.orangeworkshop.info/public_html/landmart/catalog/');
    define('DIR_LANGUAGE', DIR_APPLICATION . 'language/');
    define('DIR_TEMPLATE', DIR_APPLICATION . 'view/template/');
    define('DIR_CONFIG', DIR_SYSTEM . 'config/');
    define('DIR_CACHE', DIR_STORAGE . 'cache/');
