...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/transport')) {	
				$catalog[] = array(
					'name'	   => 'บริษัทขนส่งเอกชน',
					'href'     => $this->url->link('catalog/transport', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'setting/setting')) {
				...
				$system[] = array(
					'name'	   => 'นโยบายธุรกิจ/ความเป็นส่วนตัว',
					'href'     => $this->url->link('setting/setting/privacy', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			// ford custom
			if ($this->user->hasPermission('access', 'career/career')) {
				$career[] = array(
					'name'	   => $this->language->get('สมัครงาน'),
					'href'     => $this->url->link('career/career', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			/*$data['menus'][] = array(
				'id'       => 'menu-news_embed_youtube',
				'icon'	   => 'fa-television',
				'name'	   => $this->language->get('วีดีโอ ข่าวสารและโปรโมชัน'),
				'href'     => $this->url->link('report/embed_youtube_news', 'user_token=' . $this->session->data['user_token'], true),
				'children' => array()
			);*/

			//if ($this->user->hasPermission('access', 'report/report/news')) {
				$news[] = array(
					'name'	   => $this->language->get('วีดีโอข่าวสารและโปรโมชัน'),
					'href'     => $this->url->link('report/report/news', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			//}	
			...
			if ($this->user->hasPermission('access', 'report/report')) {
				$news[] = array(
					'name'	   => $this->language->get('ข่าวสารและโปรโมชัน'),
					'href'     => $this->url->link('report/report', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}	
