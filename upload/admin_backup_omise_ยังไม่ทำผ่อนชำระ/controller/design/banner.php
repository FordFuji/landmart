...
class ControllerDesignBanner extends Controller {
	...
	protected function getList() {
		...
		$data['text_top_menu_name'] = $this->model_design_banner->getTextTopMenu();
	...
	public function ajaxTextTopMenu() {
		$query = $this->db->query('UPDATE fd_text_top_menu SET text_top_menu_name = "'.$this->request->post['text_top_menu_name'].'" WHERE text_top_menu_id = "1"');
