...
class ModelCheckoutOrder extends Model {
	...
	public function getMemberOrderResult() {
		$query = $this->db->query("select * from oc_order where oc_order.customer_id = '".$this->session->data['member_id']."' order by oc_order.order_id desc");

		return $query->rows;
	}

	public function getOrderResult() {
		$query = $this->db->query("select * from oc_order_product inner join oc_product on oc_order_product.product_id = oc_product.product_id order by order_product_id desc");
